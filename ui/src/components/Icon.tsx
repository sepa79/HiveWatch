export function Icon({ name }: { name: 'home' | 'hive' | 'journal' | 'scenarios' | 'other' | 'user' | 'buzz' | 'settings' }) {
    ...
    case 'settings':
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M19.4 12a7.6 7.6 0 0 0-.1-1l2-1.5-2-3.5-2.4 1a7.6 7.6 0 0 0-1.7-1L14.8 3h-3.6l-.4 2.1a7.6 7.6 0 0 0-1.7 1l-2.4-1-2 3.5 2 1.5a7.6 7.6 0 0 0 0 2l-2 1.5 2 3.5 2.4-1a7.6 7.6 0 0 0 1.7 1l.4 2.1h3.6l.4-2.1a7.6 7.6 0 0 0 1.7-1l2.4 1 2-3.5-2-1.5c.1-.3.1-.7.1-1Z"
            stroke="currentColor"
            strokeWidth="1.3"
